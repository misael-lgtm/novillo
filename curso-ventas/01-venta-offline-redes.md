...
Siempre que llegamos, los pasos a seguir son estos, en este orden:

1. Contestar los mensajes de la noche/mañana anterior — ver si alguno avanza, dejar todo al día.
...
Mínimo dos veces por día, independientemente de quién sea cada tarjeta (una vez a la mañana
y una vez a la tarde). Así, cada vendedor repasa todo el CRM una vez por día.
...
después no la revisamos a tiempo — se nos pasan ventas fáciles que ya teníamos "en bandeja".
...
- **Dar por sentado que la persona va a contestar.** Escribir "hola, ¿cómo va?", "¿todo
  bien?", "¿querés llevar la campera?" en días seguidos a la misma persona no es hacer
  seguimiento, es perder el tiempo si no contesta. Mejor: escribirle un par de veces si
  creemos que va a comprar, pero usar el resto del tiempo en buscar más gente, no en
...
3. Cada vez que se contacta a un carrito, etiquetarlo también en WhatsApp con la etiqueta
   correspondiente.
4. Si no hay respuesta, volver a escribir al otro día con este mensaje (probado, da
   resultado): *"Hola... ¿nos podrías decir si estás interesado? Más que nada porque el
   producto en el cual vos estás interesado nos queda congelado en el carrito y no podemos
   disponer"*.
...
- Que el compañero ayude tiene que ser independiente de quién cierra la venta.
- Que el compañero corrija o sugiera algo no es motivo de enojo, es una mejora.
- Cada uno tiene que ser consciente de sus falencias y sus virtudes, y apoyarse en el otro.
- Hacer seguimiento a una tarjeta del compañero no es un problema — el compañero va a hacer
  lo mismo por nosotros.
- Completar bien las tarjetas del CRM con comentarios para que el otro sepa dónde está
  parada cada conversación y dónde hacer seguimiento sin perder tiempo.
- Pedir consejo si hace falta, o preguntar qué le está dando resultado al otro para poder
  aplicarlo.
...
Ponelo al día antes de seguir con el curso.
